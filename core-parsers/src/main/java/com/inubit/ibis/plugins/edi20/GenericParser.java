...
public class GenericParser {
     ...
     * @throws InubitException
     */
    public GenericParser(final StringBuilder inputText) throws InubitException {
    ...
    public GenericParser(final StringBuilder inputText, final AbstractEDIRule rule) throws InubitException {
        if (inputText == null || inputText.length() == 0) {
            throw new InubitException("Input text not set correctly!");
        }
