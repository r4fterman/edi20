...
public abstract class EDILexicalScanner implements IScanner {
     ...
     *            EDI delimiters
     */
    public EDILexicalScanner(final StringBuffer inputDocument, final IDelimiters delimiters) {
        super();
        init(inputDocument, delimiters);
    }

    private void init(final StringBuffer inputDocument, final IDelimiters delimiters) {
