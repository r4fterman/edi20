...
public interface IDelimiters {
	...
	/**
	 * @return identifier for Escape delimiter or an empty string if no such
	 *         identifier exists
	 */
	 ...
	 * @param delimiter
	 *            delimiter to check
	 * @return <code>true</code> if the given delimiter is one of these
	 *         delimiters, <code>false</code> otherwise
	 */
	 ...
	 * @param delimiter
	 *            delimiter
	 * @return delimiter identifier or -1 if the given delimiter is not one of
	 *         these delimiters
	 */
